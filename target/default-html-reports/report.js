$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/test/resources/features/acceptAlert.feature");
formatter.feature({
  "name": "accept alert",
  "description": "",
  "keyword": "Feature",
...
formatter.scenario({
  "name": "User should be able to accept alert",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "user is on the alerts page",
  "keyword": "Given "
});
formatter.match({
  "location": "com.demoqa.stepDefinitions.acceptAlertStepDef.user_is_on_the_alerts_page()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user click the second button",
  "keyword": "When "
});
formatter.match({
  "location": "com.demoqa.stepDefinitions.acceptAlertStepDef.user_click_the_second_button()"
});
formatter.result({
  "status": "passed"
});
...
formatter.match({
  "location": "com.demoqa.stepDefinitions.acceptAlertStepDef.user_should_be_able_to_accept_alert()"
});
formatter.result({
  "status": "passed"
});
...
formatter.uri("file:src/test/resources/features/datePicker.feature");
formatter.feature({
  "name": "date picker",
  "description": "",
  "keyword": "Feature",
...
formatter.uri("file:src/test/resources/features/hoverOver.feature");
formatter.feature({
  "name": "hover over",
  "description": "",
  "keyword": "Feature",
...
formatter.uri("file:src/test/resources/features/modals.feature");
formatter.feature({
...
formatter.scenario({
  "name": "User should be able to close the small modal",
  "description": "",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.step({
  "name": "user is on the modal-dialogs page",
  "keyword": "Given "
});
formatter.match({
  "location": "com.demoqa.stepDefinitions.modalsStepDef.user_is_on_the_modal_dialogs_page()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user select small modal button",
  "keyword": "When "
});
formatter.match({
  "location": "com.demoqa.stepDefinitions.modalsStepDef.user_select_small_modal_button()"
});
formatter.result({
  "status": "passed"
});
formatter.step({
  "name": "user should be able to close modal",
  "keyword": "Then "
});
formatter.match({
...
formatter.uri("file:src/test/resources/features/submitForm.feature");
formatter.feature({
